...
@section('content')
<div class="container">
<a class="btn btn-success" data-href="EmployeeController@create" id="createNewProduct"> Create New Emoployee</a>
                ...
                <form id="productForm" name="productForm" class="form-horizontal">
                   <input type="hidden" name="product_id" id="product_id">
                    ...
                    <div class="form-group">
                        ...
                        <option selected value='M'>$employee->first_name</option>
                        @endforeach --}}
